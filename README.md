...
- При мэтче бот сразу отправляет обоим участникам ссылки на профили MAX; односторонние лайки группируются в уведомление раз в 15 минут.
...
- Создание общего чата для участников мэтча.
- Выбор конкретного сеанса и совместимость дат участников для повторяющихся событий.
